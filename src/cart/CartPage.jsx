        ...
        <div style={{ maxWidth: '800px', margin: 'auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
                ...
                <div>
                    ...
                    <p style={{ margin: 0 }}>Dr.J.Karthik</p>
                    <p style={{ margin: 0 }}>Associate.Prof</p>
                    <p style={{ margin: 0 }}>CSE-H2</p>
                    <p style={{ margin: 0 }}>KLEF</p>
                </div>
                {/* Billing Address */}
                <div>
                    <h3 style={{ marginBottom: '5px' }}>Billing Address:</h3>
                    <p style={{ margin: 0 }}>Premium Customer</p>
                ...
                <tbody>
                    {cart.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td style={{ border: '1px solid #ddd', padding: '10px' }}>{item.mname}</td>
                            <td style={{ border: '1px solid #ddd', padding: '10px' }}>₹{item.mcost.toLocaleString()}</td>
                            <td style={{ border: '1px solid #ddd', padding: '10px', textAlign: 'center' }}>{item.tickets}</td>
                            <td style={{ border: '1px solid #ddd', padding: '10px' }}>
                                ₹{(item.mcost * item.tickets).toLocaleString()}
                            </td>
                        </tr>
                    ))}
                </tbody>
